...
const GetFreeQuote = () => {
  ...
  return (
    <div>
      {show && (
        <div className='contact-row-1 d-flex justify-content-center ' id='Get-free-Quota'>
          <div className='container position-absolute mt-3 border bg-1 mt-1 mb-1 w-50'>
            <div className='row mt-2 mb-3'>
              <div className='col-12 d-flex justify-content-end'>
                <button onClick={() => setShow(false)} type="button" className="btn-close p-3 btn-danger " aria-label="Close"></button>
              </div>
